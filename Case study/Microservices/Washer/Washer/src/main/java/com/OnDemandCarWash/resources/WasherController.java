package com.OnDemandCarWash.resources;
...
import com.OnDemandCarWash.repositories.UserRepository;
...
//For authentication
	...
	public String home() {
		return ("<h1>GREEN CAR WASH</h1>"
				...
				+ "<h2><a href=\"http://localhost:8091/findAllReviewsAndRatings/\">Reviews And Ratings</a></h2>");
	}
