...
class WasherServiceSystemApplicationTests {
	...
	public void getUsersTest() {
		when(repo.findAll()).thenReturn(Stream
				.of(new Washers(22, "Nithin","USA"),
						new Washers(55,"UK","jack")).collect(Collectors.toList()));
	...
	public void getUserbyAddressTest() {
		...
		when(repo.findBylocation(location))
				.thenReturn(Stream.of(new Washers(22,"sam","UK"))
	...
	public void saveUserTest() {
		Washers washer = new Washers(2, "Pranya","Pune");
	...
	public void deleteUserTest() {
		Washers washer = new Washers(1, "raju","Hyderabad");	
